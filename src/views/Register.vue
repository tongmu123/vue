			...
			return {
				...
				rules: {
					...
					checkPass: [{
						...
						trigger: 'blur'
					} /* pattern用来验证正则表达书  validator来通过函数判断*/ ],
					fullname: [{
							required: true,
							type: 'string',
							message: '请输入昵称',
			...
			handleRegister(formName) {
				this.$refs[formName].validate(async (valid) => {
					...
					let {
						...
						msg,
						data
					} = await Goods.register({ ...this.form
					});
